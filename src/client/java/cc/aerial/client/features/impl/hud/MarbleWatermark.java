...
public final class MarbleWatermark {
    public static final MarbleWatermark INSTANCE = new MarbleWatermark();
    ...
    private static final String CLIENT_NAME = "Marble";
    ...
    public void render(Render2DEvent event) {
        AerialBloomFilter.begin(BlurConsumer.MARBLE_WATERMARK);
        try {
    ...
    private void onRender2DBody(Render2DEvent event) {
        ...
        AerialBlur.drawGlass(extractor, BlurConsumer.MARBLE_WATERMARK, x, y, totalW, PILL_HEIGHT,
